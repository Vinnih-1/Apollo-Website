...
const Login = () => {
  ...
  const loginUrl = process.env.NEXT_PUBLIC_AUTH_LOGIN as string
      ...
      <div className="flex flex-col items-center gap">
        ...
        <div className="max-w-md bg-white border-2 w-full h-auto rounded-xl">
          <div className="flex flex-col items-center">
            <h1 className="text-blue-600 font-bold text-4xl my-8">Sign in</h1>
            ...
            <button
              type="button"
              id="loginButton"
              className="py-6 md:py-3 bg-blue-600 rounded w-40 text-white text-sm my-8"
              onClick={() => {
                setAuth((prevState) => ({
                  ...prevState,
                  authenticating: true,
